...
public class ChoiceRunner {
    ...
    private final static int version = 2; /*enter from 1 to 5*/
    ...
    public static void main(String[] args) {
        ...
        if (usePSQL)
            switch (version) {
                case 1:
                    ai = new com.mycompany.textanalyzer.psql.v1
                            .analyzer.Analyzer(stats);   
                    break;
                case 2:
                    ai = new com.mycompany.textanalyzer.psql.v2
                            .analyzer.Analyzer(stats);   
                    break;
                case 3:
                    ai = new com.mycompany.textanalyzer.psql.v3
                            .analyzer.Analyzer(stats);   
                    break;
                case 4:
                    ai = new com.mycompany.textanalyzer.psql.v3_1
                            .analyzer.Analyzer(stats);   
                    break;
                case 5:
                    ai = new com.mycompany.textanalyzer.psql.v3_2
                            .analyzer.Analyzer(stats);   
                    break;
            }
        else
