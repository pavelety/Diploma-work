package com.mycompany.textanalyzer.psql.v3_1.analyzer;
 ...
 * БД dictionaryr/e
 * Поиск ведется с помощью единого запроса, используя like
 * (8 слова в секунду)
 * @author pavel
 */
public class Analyzer implements AnalyzerInterface {
    private final String selectLexemEng = 
    ...
    private final String selectLexemRus = 
            "select bases.basestr, suffixes.suffix, "
